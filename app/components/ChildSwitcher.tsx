    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute left-1/2 z-50 mt-2 w-60 -translate-x-1/2 overflow-hidden rounded-2xl border border-line bg-surface p-1 text-left shadow-xl">
            {siblings.map((k) => {
              ...
              return (
                <button
                  ...
                  className="tap flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm active:bg-surface-muted"
                >
                  <span>👶</span>
            ...
            <button onClick={() => go("/children?add=1")} className="tap flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm font-medium text-brand-600 active:bg-surface-muted">
              <span>＋</span> Add a child
            </button>
            <button onClick={() => go("/settings")} className="tap flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-ink-soft active:bg-surface-muted">
